...
public class DustHitState : EnemyState
{
    private Enemy_Dust enemy;

    public DustHitState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_Dust _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
    ...
    public override void Enter()
    {
        ...
        stateTimer = enemy.stunDuration;//初始化受击时间
